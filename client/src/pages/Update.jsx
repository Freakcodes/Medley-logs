...
const Update = () => {
  ...
  const mutation = useMutation({
    mutationFn: async (data) => {
      ...
      const res = axios.patch(`${import.meta.env.VITE_API_URL}/posts/${slug}`, data, {
        headers: {
...
useEffect(() => {
  if (post) {
    ...
    setValue("shortDescription", post.desc); // or wherever you store desc
    setContent(post.content);
    setCoverImage(post.img);
  }
}, [post, setValue]);
